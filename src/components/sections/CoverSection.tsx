  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `url(${bgCoverPortrait})`,
      ...
      <div className="relative z-10 flex flex-col items-center text-center h-full px-6 pt-10 sm:pt-16 pb-6">
        ...
        <p data-reveal="fade-up" data-reveal-delay="0" className="text-[11px] sm:text-xs tracking-[0.55em] font-display text-gold-soft uppercase drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
          The Wedding Of
        </p>
        <h1 data-reveal="fade-scale" data-reveal-delay="200" className="mt-5 text-[46px] sm:text-7xl font-display text-gradient-gold leading-[0.95] drop-shadow-[0_4px_16px_rgba(0,0,0,0.85)]">
          ARUNA
        </h1>
        <span data-reveal="fade-up" data-reveal-delay="400" className="my-1 text-3xl sm:text-4xl font-script text-gold-soft drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">&amp;</span>
        <h1 data-reveal="fade-scale" data-reveal-delay="500" className="text-[46px] sm:text-7xl font-display text-gradient-gold leading-[0.95] drop-shadow-[0_4px_16px_rgba(0,0,0,0.85)]">
          SASMITA
        </h1>

        <Divider data-reveal="curtain" data-reveal-delay="700" className="mt-7" />

        <p data-reveal="fade-up" data-reveal-delay="900" className="mt-5 text-sm sm:text-lg tracking-[0.4em] text-gold-soft font-display">
          20 - 12 - 2025
        </p>
        <p data-reveal="fade-up" data-reveal-delay="1000" className="mt-2 text-[10px] sm:text-xs tracking-[0.15em] text-gold/80 italic font-serif">
